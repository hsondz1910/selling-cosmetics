...
$(document).ready(function () {
  ...
  $(".Order").click(function () {
    ...
    if (name === "" || address === "" || phone === "" || email === ""|| noted==="") {
        alert("Vui lòng điền đầy đủ thông tin!");
        return; // Ngăn chặn tiến trình tiếp tục nếu có bất kỳ trường nào trống
    }
